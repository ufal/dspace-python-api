...
# override in your own code if you want to do something else
def check_response(_1, _2):
    pass
...
class DSpaceClient:
    ...
    def search_objects(self, query=None, filters=None, dso_type=None):
        ...
        try:
            ...
            logging.info(f'error parsing search result json {err}')
    ...
    def fetch_resource(self, url, params=None):
        ...
        if r.status_code != 200:
            logging.warning(f'Error encountered fetching resource: {r.text}')
            return None
    ...
    def create_bitstream(self, bundle=None, name=None, path=None, mime=None,
        ...
        if r.status_code == 201 or r.status_code == 200:
            ...
            logging.info(f'Error creating bitstream: {r.status_code}: {r.text}')
            return None
    ...
    def get_communities(self, uuid=None, page=0, size=20, top=False):
        ...
        logging.info(f'Performing get on {url}')
        # Perform actual get
